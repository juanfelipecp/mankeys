      ...
      <div id="carouselExampleCaptions" class="carousel slide" data-ride="carousel">
        ...
        <div class="carousel-inner">
          <div class="carousel-item active">
            <img src="https://store.nintendo.co/media/catalog/product/cache/1aff59ff6f21b2058ac5563c018426d7/y/c/ycw-switch-swbanner-v2-1920x1080.jpg" class="d-block w-90" alt="..."width="2000px" height="700px">
            <div class="carousel-caption d-none d-md-block">
              <h5>yoshi´s crafted world</h5>
              <p>una nueva aventura con yoshi</p>
            </div>
          </div>
          <div class="carousel-item">
            <div class="center">
            <img src="https://hipertextual.com/files/2020/03/hipertextual-animal-crossing-new-horizons-2020410955.jpg" class="d-block w-90" alt="..." width="2000px" height="700px" >
          </div>
            <div class="carousel-caption d-none d-md-block">
