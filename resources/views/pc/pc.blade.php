      ...
      <div id="carouselExampleCaptions" class="carousel slide" data-ride="carousel">
        ...
        <div class="carousel-inner">
          <div class="carousel-item active">
            <img src="https://steamcdn-a.akamaihd.net/steam/apps/35140/header.jpg?t=1569358035" class="d-block w-90" alt="..."width="2000px" height="700px">
          ...
          <div class="carousel-item">
            <div class="center">
            <img src="https://fanatical.imgix.net/product/original/0bdff20f-f63b-4776-8654-02927fd0974b.jpeg?auto=compress,format&w=400&fit=max" class="d-block w-90" alt="..." width="2000px" height="700px" >
          </div>
            <div class="carousel-caption d-none d-md-block">
              <h5>Hotline Miami</h5>
              <p>matar</p>
