...
<body background="https://images6.alphacoders.com/963/963333.png">
    <nav class="navbar navbar-expand-lg ">
        <a class="navbar-brand" href="{{ route('indexp') }}">Mankeys <img
                src="https://mundomuymisterioso.files.wordpress.com/2013/01/056___mankey_by_winter_freak-d32qywq.jpg"
    ...
    <div id="carouselExampleCaptions" class="carousel slide" data-ride="carousel">
        ...
        <div class="carousel-inner">
            <div class="carousel-item active">
                <img src="https://steamcdn-a.akamaihd.net/steam/apps/35140/header.jpg?t=1569358035" class="d-block w-90"
                    alt="..." width="2000px" height="700px">
                <div class="carousel-caption d-none d-md-block">
                    <h5>Batman Arkham Asylum</h5>
                    <p>vive la aventura de Batman</p>
                </div>
            </div>
            ...
            <div class="carousel-item">
                <img src="https://edbatista.typepad.com/mankeybusiness/images/2005/05-02-13-03.jpg" class="d-block w-90"
                    alt="..." width="2000px" height="700px">
                <div class="carousel-caption d-none d-md-block">
                    <h5>frank </h5>
                    <p>un inutil </p>
